...
class FamiliaresUpdateRequest extends Request {
    ...
    {
        return [
            'cedula'    => 'required|regex:/^[VE]-[0-9]{5,8}$/|max:10|unique:familiares,cedula,'.$this->id,
    ...
    public function messages()
    {
        return [
            ...
            'parentesco.max'              => 'Parentesco tiene más de 1 caractér',            
        ];
    }  
