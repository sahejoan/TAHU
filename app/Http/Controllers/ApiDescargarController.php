...
class ApiDescargarController extends Controller {
  ...
  public function DescargaFuncionarios(Request $request)
  {
    ...
    //Con el qr nuevo
    //$obj = funcionarios::select('id',DB::raw('nuevoqr as cedula'),'nombre','apellido','id_dep','ancho','alto','tipoimagen','foto')->where('id','>','0')->orderby('id')->get()->toArray();
  ...
  public function DescargaelFuncionario(Request $request)
  {
    ...
    //Con el qr nuevo
    //$obj = funcionarios::select('id',DB::raw('nuevoqr as cedula'),'nombre','apellido','id_dep','ancho','alto','tipoimagen','foto')->where('cedula','=',$cedula)->orderby('id')->get()->toArray();
