  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      "columns": [
                    { className: "col-lg-3 col-xs-3 col-sm-3 col-md-3 text-left" },
                    { className: "col-lg-3 col-xs-3 col-sm-3 col-md-3 text-left" },
      ...
      'language'    : {
        ...
        columns: [
            {data: 'nom_area', className: 'col-lg-3 col-xs-3 col-sm-3 col-md-3 text-left', name: 'nom_area'},
            {data: 'ubicacion', className: 'col-lg-3 col-xs-3 col-sm-3 col-md-3 text-left', name: 'ubicacion'},
            {data: 'nombre', className: 'col-lg-2 col-xs-2 col-sm-2 col-md-2 text-left', name: 'nombre'},            
            {data: 'telf_area', className: 'col-lg-2 col-xs-2 col-sm-2 col-md-2 text-left', name: 'telf_area'},
            {data: 'descripcion', className: 'col-lg-2 col-xs-2 col-sm-2 col-md-2 text-left', name: 'descripcion'},            
            {
              data: null,
              bSortable: false,
              mRender: function(data, type, value) {
                ...
                if (info.length!=-1) {
                  if (value["ver"]>0) {
                    return '<center><a class="btn btn-info btn-xs far fa-id-card" title="Mostrar registro" data-toggle="modal" data-target="#modalmostrar" onclick="buscararea('+value["ver"]+');"></a></center>';  
                  } else {
            ...
            },            
            {
              ...
              mRender: function(data, type, value) {
                ...
                if (info.length!=-1) {                
                  if (value["editar"]>0) {
                    var xroute = "{{ route('area.edit',['area'=>'__idarea']) }}";
                    xroute = xroute.replace('__idarea', value["editar"]);
            ...
            },
            {
              ...
              mRender: function(data, type, value) {
                ...
                if (info.length!=-1) {                                
                  if (value["borrar"]>0) {
                    var xroute = "{{ route('area.destroy',['area'=>'__idarea']) }}";
                    xroute = xroute.replace('__idarea', value["borrar"]);
                    ...
                    doc['header'] = (function (page, pages) {
                        return {
                            table: {
                                ...
                                body: [
                                    [{ image: logo, width: 50 }],
                                    [{ text: 'Lista de áreas', alignment: 'center', fontSize: 14, bold: true, margin: [0, 10, 0, 0] }],
                                    [
                                        {
                                            text:
                                                [
                ...
                customize: function ( win ) {                  
                    ...
                    $(win.document.body)
                        ...
                        .prepend(                          
                            ...
                            '<br><br><div style="font-size:18px;">Dependencia: '+general_dep+'<br>Ubicación: '+general_ubi+'<br>Región: '+general_reg+'</div><div align="center" style="font-size:20px;">Lista de áreas</div>' 
                        );
    ...
    function buscararea(id) {           
      ...
      $.ajax({
          ...
          success: function(response) {
              if (response!="Error") {
                  $('#datosarea').remove();            
                  $("#resultdatos").append(`<div id="datosarea" align="left">`+
                  ...
                  <span class="bg-green">Área</span>
                  </div>              
                  <div>
                  <i class="fas fa-phone bg-blue"></i>
                  <div class="timeline-item">
                  <span class="time"><i class="fas fa-info"></i></span>
                  <h3 class="timeline-header"><a href="#">Teléfono</a>&nbsp;`+response.telf_area+`</h3>
                  ...
                  <div class="timeline-item">
                  <span class="time"><i class="fas fa-info"></i></span>
                  <h3 class="timeline-header no-border"><a href="#">Coordenadas</a>&nbsp;`+ response.coord_area+`</h3>
                  </div>
                  </div>
                  <div>
                  ...
                  <div class="timeline-item">
                  <span class="time"><i class="fas fa-info"></i></span>
                  <h3 class="timeline-header"><a href="#">División</a>&nbsp;</h3>
                  <div class="timeline-body">`+response.descripcion+`</div>
                  <div class="timeline-footer">
                  </div>
                  </div>
