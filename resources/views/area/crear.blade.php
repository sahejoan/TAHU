...
<div>
{!!Form::open(array('name' => 'form', 'route' => array('area.store'), 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data'))!!}     
                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('ubicacion', $sti, 'GERENCIA REGIONAL CALABOZO', array('id'=>'ubicacion' , 'class'=>'form-control select2', 'data-placeholder'=>'Seleccionar', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.coord_area.focus();}'))!!}
                            </div>                            
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_divi', $objdivision, 'Escribir [Enter Busca]', array('id'=>'id_divi' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.id_func.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_func', $objfuncionario, 'Escribir [Enter Busca]', array('id'=>'id_func' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.nom_area.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
