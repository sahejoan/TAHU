...
<div>
{!!Form::open(array('name' => 'form', 'route' => array('cargofuncionario.store'), 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data'))!!}     
...
<div class="wrapper">
                ...
                <div class="card card-primary" style="background-color: #ebdef0;">
                    ...
                    <form>
                        <div class="card-body">
                              ...
                              <div class="col-xs-10 col-ms-10 col-md-10">
                                <div id="earea"> 
                                  <div class="form-group">
                                    ...
                                    {!!Form::select('id_lcargo', $objlcargo, 'Escribir [Enter Busca]', array('id'=>'id_lcargo' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.fecha_ex.focus();}'))!!}
                                  </div>
                                </div>          
                              </div>
                            </div> 
                              ...
                              <div class="col-md-4">
                                <div id="ecargo"> 
                                  <div class="form-group">
                                    ...
                                    {!!Form::select('sta_cargo', $objestatuscargo, '', array('id'=>'sta_cargo' , 'class'=>'form-control select2', 'data-placeholder'=>'Seleccionar', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.st_contrato.focus();}'))!!}
                                  </div>
                                </div>          
                              </div>
                              <div class="col-md-4">
                                <div id="ecargo"> 
                                  <div class="form-group">
                                    ...
                                    {!!Form::select('sta_contrato', $objestatuscontratado, '', array('id'=>'sta_contrato' , 'class'=>'form-control select2', 'data-placeholder'=>'Seleccionar', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.observaciones.focus();}'))!!}
                                  </div>
                                </div>                                          
                              </div>
                              <div class="col-md-4">
                            ...
                            <center><a class="btn btn-info btn-sm fa fa-list-alt" title="Lista" data-toggle="modal" data-target="#modalmostrar"> Agregar funciones al cargo</a></center>
	...
	<div class="row">
        ...
        <div class="col-xs-5 col-sm-5 col-md-5" align="center">  
            ...
            <a href="{!!URL::to('/designacion')!!}" class="btn btn-danger btn-flat" title="Cerrar Formulario"><i class="fa fa-ban"></i> Cancelar</a>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4">  
        </div>
  </div>
