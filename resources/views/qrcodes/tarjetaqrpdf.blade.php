        ...
        @foreach($objfuncionarios as $funcionario)
            <div class="box">
              ...
              <div class="">
                ...
                <!--<img src='{{ $imprimirQR->getImagen(Arr::get($funcionario,"cedula"),Arr::get($funcionario,"cedula"), Arr::get($funcionario,"nombre"), Arr::get($funcionario,"apellido"), 300) }}' width="95%" height="95%"/>-->
              </div>
            </div>            
        @endforeach                                                
        </div>
