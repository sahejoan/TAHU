...
@section('content')
  <section class="section">
      ...
      <h7 class="page__heading">
        ...
        <div class="btn-group">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio1').checked = true;PorTipo('TODOS');">
                <div class="icheck-primary d-inline">
                  <input type="radio" id="radio1" name="r1" value ="TODOS" onclick="PorTipo('TODOS');" <?php echo isset($tipo) ? ($tipo=='TODOS' ? 'checked=""' : ''): 'checked=""'; ?>>
                  <label style="font-size: 10;font-weight: normal;" for="radioPrimary1">General</label>
                </div>                                    
              </a>
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio2').checked = true;PorTipo('RETARDADOS');">
                <div class="icheck-primary d-inline">
                  <input type="radio" id="radio2" name="r1" value ="RETARDADOS" onclick="PorTipo('RETARDADOS');" <?php echo isset($tipo) ? ($tipo=='RETARDADOS' ? 'checked=""' : ''): ''; ?>>
                  <label style="font-size: 10;font-weight: normal;"  for="radioPrimary1">Retardos</label>
                </div>                                    
              </a>
            </div>
          </div>
    ...
    <input type="hidden" name="tipo" id="tipo" value="<?php echo isset($tipo) ? $tipo:'TODOS'; ?>">
...
@section("scripts")
  ...
  <script>
    ...
    var peticion2=0;
    var peticion3=0;
    var etiquetatipo = '<?php echo isset($tipo) ? $tipo:''; ?>';
