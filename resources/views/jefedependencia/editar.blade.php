...
{!!Form::model($objjefedependencia, array('name' => 'form', 'route' => array('jefedependencia.update',$objjefedependencia->id), 'method' => 'put', 'ENCTYPE'=>'multipart/form-data', 'files' => true))!!}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="card card-primary" style="background-color: #ebdef0;">
                    <div class="card-header bg-purple">
                        <h3 class="card-title">Actualizar jefe</h3>
                    </div>
                    <form>
                        <div class="card-body">
