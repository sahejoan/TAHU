                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('ubicacion', $objubicacion, 'Seleccionar', array('id'=>'ubicacion' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.id_jefedep.focus();}'))!!}                                
                            </div>
                            </div>            
                            </div>
