        ...
        buttons: [
            {
                ...
                title:     'Lista de Actividades de Designaciones',
                exportOptions: {
                    ...
                    doc['header'] = (function (page, pages) {
                        return {
                            table: {
                                ...
                                body: [
                                    [{ image: logo, width: 50 }],
                                    [{ text: 'Lista de actividades', alignment: 'center', fontSize: 14, bold: true, margin: [0, 10, 0, 0] }],
                                    [
                                        {
                                            text:
                                                [
                ...
                customize: function ( win ) {                  
                    ...
                    $(win.document.body)
                        ...
                        .prepend(                          
                            ...
                            '<br><br><div style="font-size:18px;">SENIAT: Región Los Llanos<br>Sede: Calabozo</div><div align="center" style="font-size:20px;">Lista de Actividades de Designaciones</div>'
                        );
