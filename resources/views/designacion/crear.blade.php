                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_func', $objfuncionarios, 'Escribir [Enter Busca]', array('id'=>'id_func' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.id_dep.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>
