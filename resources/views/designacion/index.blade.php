            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio1').checked = true;Refrescar();">
                <div class="icheck-primary d-inline">
                  ...
                  <label style="font-size: 10;font-weight: normal;" for="radioPrimary1">Todos <label style="font-size: 9px;">(Designaciones registradas)</label></label>
                </div>                                    
              </a>
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio2').checked = true;Refrescar();">
                <div class="icheck-primary d-inline">
                  ...
                  <label style="font-size: 10;font-weight: normal;"  for="radioPrimary1">Activos <label style="font-size: 9px;">(Designaciones registradas)</label></label>
                </div>                                    
              </a>
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio3').checked = true;Refrescar();">
                <div class="icheck-primary d-inline">
                  ...
                  <label style="font-size: 10;font-weight: normal;" for="radioPrimary1">Culminados <label style="font-size: 9px;">(Designaciones registradas)</label></label>
                </div>                                    
              </a>
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio4').checked = true;Refrescar();">
                <div class="icheck-primary d-inline">
                  ...
                  <label style="font-size: 10;font-weight: normal;" for="radioPrimary1">Jubilados <label style="font-size: 9px;">(Designaciones registradas)</label></label>
                </div>                                    
              </a>              
            </div>
          </div>
