        ...
        <div class="btn-group">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
              ...
              @endif
              <a class="dropdown-item" href="{{route('calendario')}}" title="Vista actual"><i class="fa fa-gift"></i> Cumpleaños del Mes</a>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
              ...
              <a class="dropdown-item" href="#" onclick="document.getElementById('radio5').checked = true;Refrescar();">
                <div class="icheck-primary d-inline">
                  ...
                  <label style="font-size: 10;font-weight: normal;" for="radioPrimary1">Sin designaciones <label style="font-size: 9px;">(Solo por dependencia)</label></label>
                </div>                                    
              </a>              
            </div>
          </div>
...
@section("scripts")
  ...
  @include('funcionarios.jsselect2')
