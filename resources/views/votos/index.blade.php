...
@section('css')
    ...
    <style>
      .logopdf {
        ...
        content:url("{{ asset('img/logo1.jpg') }}");
      }
      ...
      $.ajax({
          ...
          success: function(response) {
              if (response!="Error") {
                ...
                if ($("#id_dep").val()>5) {                
                  var titulo = "GRTI LOS LLANOS";
                  var region = $("#id_dep").val();
                ...
                if ($("#id_dep").val()==1) {
                  var titulo = "GERENCIA REGIONAL DE TRIBUTOS INTERNO";
                  var region = $("#id_dep").val();

                  datac[0].y = datat[1].p;
                  datac[1].y = datat[1].np;                                    
                }
                if ($("#id_dep").val()==2) {
                  var titulo = "S.T.I. SAN JUAN DE LOS MORROS";
                  var region = $("#id_dep").val();

                  datac[0].y = datat[2].p;
                  datac[1].y = datat[2].np;                                                      
                }
                if ($("#id_dep").val()==3) {
                  var titulo = "S.T.I. SAN FERNANDO DE APURE";
                  var region = $("#id_dep").val();

                  datac[0].y = datat[3].p;
                  datac[1].y = datat[4].np;                                                      
                }
                if ($("#id_dep").val()==4) {
                  var titulo = "U.T.I. ALTAGRACIA DE ORITUCO";
                  var region = $("#id_dep").val();
                ...
                if ($("#id_dep").val()==5) {
                  var titulo = "S.T.I. VALLE DE LA PASCUAL";
                  var region = $("#id_dep").val();

                  datac[0].y = datat[5].p;
                  datac[1].y = datat[5].np;                                                      
                }
                
                Grafico(datac,datat,ancho_,alto_,titulo,vr,region);                                 
              }else{
