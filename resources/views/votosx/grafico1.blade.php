...
function Grafico(_datac,_datat,ancho,alto,subtitulo,vr) {
  $(function() {    
      ...
      chart: {
        ...
        events: {
          render: function() {                  
            ...
            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 15, 410, 130,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, 'STI San Fernando de Apure', 10, 410, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 145, 410, 95,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[3].p+_datat[3].np, 150, 410, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 240, 410, 90,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[3].p, 250, 410, '#FBFCFC');    
            createLabel(this, '('+porcentaje(_datat[3].p,_datat[3].p+_datat[3].np)+'%)', 275, 410, '#FBFCFC');    

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 330, 410, 110,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[3].np, 335, 410, '#FBFCFC');    

            //4********

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 15, 430, 130,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, 'STI Valle de la Pascua ', 10, 430, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 145, 430, 95,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[5].p+_datat[5].np, 150, 430, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 240, 430, 90,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[5].p, 250, 430, '#FBFCFC');    
            createLabel(this, '('+porcentaje(_datat[5].p,_datat[5].p+_datat[5].np)+'%)', 275, 430, '#FBFCFC');    

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 330, 430, 110,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[5].np, 335, 430, '#FBFCFC');    

            //5********

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 15, 450, 130,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, 'STI San Juan de los Morros', 10, 450, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 145, 450, 95,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[2].p+_datat[2].np, 150, 450, '#FBFCFC');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 240, 450, 90,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[2].p, 250, 450, '#FBFCFC');    
            createLabel(this, '('+porcentaje(_datat[2].p,_datat[2].p+_datat[2].np)+'%)', 275, 450, '#FBFCFC');    

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 330, 450, 110,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[2].np, 335, 450, '#FBFCFC');                

            //6********

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 15, 470, 130,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, 'UTI Altagracia de Orituco', 10, 470, '#5D6D7E');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 145, 470, 95,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[4].p+_datat[4].np, 150, 470, '#5D6D7E');

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 240, 470, 90,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[4].p, 250, 470, '#5D6D7E');    
            createLabel(this, '('+porcentaje(_datat[4].p,_datat[4].p+_datat[4].np)+'%)', 275, 470, '#FBFCFC');    

            //createRect(this, x, y, w, '#5D6D7E');
            createRect(this, 330, 470, 110,'#FBFCFC');
            //createLabel(this, text, x, y, '#5D6D7E');                        
            createLabel(this, _datat[4].np, 335, 470, '#5D6D7E'); 
