      ...
      <div class="col" align="left">
            ...
            @if (count($objroles)>0)
              <div class="table-responsive" align = "left" style="width: 100%"> 
                ...
                <thead class='table-danger' style="background-color:#c52036;">
                  <tr>
                  <th style="color:#fff;"></th>                  
                  <th style="color:#fff;">Rol</th>
                  <th align="center" style="color:#fff;">Editar</th>
                  <th align="center" style="color:#fff;">Borrar</th>
                  </tr>
                </thead>
               
                <tfoot class='table-danger' style="background-color:#c52036;">
                <tr>
                  <th style="color:#fff;"></th>                  
                  <th style="font-size=10px;font-weight: normal; color:#fff">Rol</th>
                  <th style="font-size=10px;font-weight: normal; color:#fff">Editar</th>
                  <th style="font-size=10px;font-weight: normal; color:#fff">Borrar</th>                  
                </tr>                
                </tfoot> 
