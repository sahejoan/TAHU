...
<head>
    ...
    <title>Notificación Web TAHU - SENIAT</title>
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="left" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="{!!URL::to('img/logo2.png')!!}" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        ...
                        <td align="center" class="section-img">
                            <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="{!!URL::to('img/logo1.png')!!}" style="display: block; width: 590px;" width="590" border="0" alt="" /></a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                                ...
                                Notificación <span style="color: #5caad2;">RECUPERACION DE CUENTA</span>
                            ...
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px" align="left">
                                           <p><strong>De: </strong>{{ $remitente }} </p>
                                           <p><strong>Para: </strong>{{ $destinatario }} </p>
                                           <p><strong></strong>{{ $m }} </p>
                                           <p><strong></strong>{{ $m1 }} </p>
                                           <p><strong></strong>{{ $m2 }} </p>

                                            <br>
                                            Si Usted no solicito recuperar la cuenta, olvide este correo.
                                            <br>
                                            No respondas a este correo. Si tienes alguna pregunta, ve al centro de ayuda de la empresa que envio el correo.
                                            Disfruta de tu servicio. 
                                            El equipo de desarrollo de Software SENIAT Web
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="" style="color: #ffffff; text-decoration: none;">ACEPTAR</a>
                                        </div>
                                    </td>
                                </tr>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590 bg_color">
                    ...
                    <tr>
                        <td>
                            <table border="0" width="300" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            <br/> <center><a href="#" style="color: red; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">SENIAT</a></center>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">seniat.gob.ve</span>
