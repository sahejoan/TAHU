...
<div>
{!!Form::open(array('name' => 'form', 'route' => array('dependencia.store'), 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data'))!!}     
                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_jefedep', $objjefedependencia, 'Escribir [Enter Busca]', array('id'=>'id_jefedep' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.ubicacion.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_reg', $objregion, 'Escribir [Enter Busca]', array('id'=>'id_reg' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.id_area.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>                                                   
