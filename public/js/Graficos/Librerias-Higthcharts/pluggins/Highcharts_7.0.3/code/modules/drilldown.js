...
*/
(function(l) { "object" === typeof module && module.exports ? (l["default"] = l, module.exports = l) : "function" === typeof define && define.amd ? define(function() { return l }) : l("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function(l) {
    (function(e) {
        var l = e.animObject,
            w = e.noop,
            x = e.color,
            ...
            u = e.fireEvent,
            C = 1;
        r(y.lang, { drillUpText: "\u25c1 Ir a {series.name}" });
        y.drilldown = {
        ...
        e.SVGRenderer.prototype.Element.prototype.fadeIn = function(a) { this.attr({ opacity: .1, visibility: "inherit" }).animate({ opacity: t(this.newOpacity, 1) }, a || { duration: 250 }) };
        ...
        n.prototype.addSingleSeriesAsDrilldown = function(a, b) {
            var c = a.series,
                ...
                m = [],
                k, q, l;
            l = this.styledMode ? { colorIndex: t(a.colorIndex, c.colorIndex) } : { color: a.color || c.color };
        ...
        n.prototype.getDrilldownBackText = function() { var a = this.drilldownLevels; if (a && 0 < a.length) return a = a[a.length - 1], a.series = a.seriesOptions, D(this.options.lang.drillUpText, a) };
        n.prototype.showDrillUpButton = function() {
            ...
            this.drillUpButton ? this.drillUpButton.attr({ text: b }).align() :
                (f = (d = c.theme) && d.states, this.drillUpButton = this.renderer.button(b, null, null, function() { a.drillUp() }, d, f && f.hover, f && f.select).addClass("highcharts-drillup-button").attr({ align: c.position.align, zIndex: 7 }).add().align(c.position, !1, c.relativeTo || "plotBox"))
        };
            ...
            if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
                for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, d = b.length, f = a.series, h, g, e, k, q = function(b) {
                    ...
                    if (g = b[d], g.levelNumber === c) {
                        ...
                        if (!e.chart)
                            for (h = f.length; h--;)
                                if (f[h].options.id === g.lowerSeriesOptions.id && f[h].options._levelNumber === c + 1) { e = f[h]; break }
                        e.xData = [];
                        g.levelSeriesOptions.forEach(q);
                        u(a, "drillup", { seriesOptions: g.seriesOptions });
        ...
        e.addEvent(n, "beforeShowResetZoom", function() { if (this.drillUpButton) return !1 });
            ...
            (this.xAxis || []).forEach(function(a) {
                ...
                a.series.forEach(function(b) {
                    var c, d = b.xData || [],
                        f = b.points,
                        h;
                    for (c = 0; c < d.length; c++) h = b.options.data[c], "number" !== typeof h && (h = b.pointClass.prototype.optionsToObject.call({ series: b }, h), h.drilldown && (a.ddPoints[d[c]] || (a.ddPoints[d[c]] = []),
        ...
        p.prototype.animateDrilldown = function(a) {
            var b = this,
                ...
                g = this.xAxis,
                m = c.styledMode;
            a || (d.forEach(function(a) { b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId && (f = a.shapeArgs, m || (f.fill = a.color)) }), f.x += t(g.oldPos, g.pos) - g.pos, this.points.forEach(function(a) {
                var c = a.shapeArgs;
                m || (c.fill =
                    a.color);
                a.graphic && a.graphic.attr(f).animate(r(a.shapeArgs, { fill: a.color || b.color }), e);
        ...
        p.prototype.animateDrillupFrom = function(a) {
            var b = l(this.chart.options.drilldown.animation),
                ...
                f = this;
            f.trackerGroups.forEach(function(a) { if (f[a]) f[a].on("mouseover") });
            d && delete this.group;
            this.points.forEach(function(h) {
                ...
                g && (delete h.graphic,
                    f.chart.styledMode || (m.fill = a.color), b.duration ? g.animate(m, e.merge(b, { complete: k })) : (g.attr(m), k()))
            })
        };
        A && r(A.prototype, {
            ...
            animateDrilldown: function(a) {
                ...
                a || (this.points.forEach(function(a, k) {
                    ...
                    if (a.graphic) a.graphic.attr(e.merge(d, { start: f + k * h, end: f + (k + 1) * h }))[c ? "animate" : "attr"](m, c)
                }), this.animate = null)
            }
        });
        ...
        e.Axis.prototype.drilldownCategory = function(a, b) {
            z(this.getDDPoints(a), function(c) { c && c.series && c.series.visible && c.doDrilldown && c.doDrilldown(!0, a, b) });
            this.chart.applyDrilldown()
        };
        e.Axis.prototype.getDDPoints = function(a) { return this.ddPoints && this.ddPoints[a] };
        B.prototype.drillable = function() {
            ...
            d && (b && f && f.length ? (b.drillable = !0, b.basicStyles || h || (b.basicStyles = e.merge(b.styles)), b.addClass("highcharts-drilldown-axis-label").on("click", function(b) { c.drilldownCategory(a, b) }), h || b.css(c.chart.options.drilldown.activeAxisLabelStyle)) : b && b.drillable && (h || (b.styles = {}, b.css(b.basicStyles)), b.on("click", null), b.removeClass("highcharts-drilldown-axis-label")))
        };
        e.addEvent(e.Point, "afterInit",
            function() {
                var a = this,
                    b = a.series;
                a.drilldown && e.addEvent(a, "click", function(c) { b.xAxis && !1 === b.chart.options.drilldown.allowPointDrilldown ? b.xAxis.drilldownCategory(a.x, c) : a.doDrilldown(void 0, void 0, c) });
                return a
            });
        ...
        e.addEvent(e.Series, "afterDrawTracker", function() {
            ...
            this.points.forEach(function(b) { b.drilldown && b.graphic && v(b.graphic, "pointer", !0, a) })
        });
