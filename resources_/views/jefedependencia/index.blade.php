  ...
  <section class="section">
        ...
        <div class="btn-group">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">            
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="{{route('monitorjefedependencia.index')}}"><i class="fa fa-desktop"></i> Actividades</a>
              @endif
            </div>
          </div>
        </div>        
        Jefes/Responsables: <label style="font-size: 12pt;font-weight: normal;">Dependencias, Divisiones o Coordinaciones</label>
      </h7>                        
    </div>        
    ...
    <div class="col-xs-1 col-sm-1 col-md-1" align="left">
      ...
      <div class="col-xs-5 col-sm-5 col-md-5" align="center">
          @if (Auth::user()->hasAnyPermission('4_Crear_jefes'))
            <a class="btn btn-success" href="{{route('jefedependencia.create')}}">Nuevo jefe</a>                              
          @endif
      </div>      
    </div>  
    <br>
...
@section("scripts")
  ...
  @include('jefedependencia.jsindex')  
