  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      'language'    : {
        ...
        columns: [
            {data: 'nom_area', className: 'col-lg-4 col-xs-4 col-sm-4 col-md-4 text-left', name: 'nom_area'},
            {data: 'ubicacion', className: 'col-lg-4 col-xs-4 col-sm-4 col-md-4 text-left', name: 'ubicacion'},
