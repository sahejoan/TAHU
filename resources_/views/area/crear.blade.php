                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::text('ubicacion', null, array('id' => 'ubicacion', 'maxlength'=>'190', 'class' => 'input-sm col-md-10 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input', 'placeholder' => 'Dirección', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.coord_area.focus();}'))!!}                                                                                    
                            </div>                            
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_divi', $objdivision, 'Escribir [Enter Busca]', array('id'=>'id_divi' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.nom_area.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>
