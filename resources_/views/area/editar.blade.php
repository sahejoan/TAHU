                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_divi', $objdivision, $objarea->id_divi, array('id'=>'id_divi' , 'class'=>'form-control select2', 'data-placeholder'=>'Escribir [Enter Busca]', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.nom_area.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>
