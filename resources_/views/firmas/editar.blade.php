...
<div>
{!!Form::model($objfirmas, array('name' => 'form', 'route' => array('firmas.update',$objfirmas->id), 'method' => 'put', 'ENCTYPE'=>'multipart/form-data', 'files' => true))!!}
                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('id_dep', $objubicacion, $objfirmas->id_dep, array('id'=>'id_dep' , 'class'=>'form-control select2', 'data-placeholder'=>'Seleccionar', 'style'=>'width: 100%;', 'onkeyDown'=>'if(event.keyCode==13 || event.which==13){document.form.actual.focus();}'))!!}
                            </div>
                            </div>          
                            </div>            
                            </div>
