...
{!!Form::close()!!}
  ...
  <section class="section">
    <div class="section-header">
      <h3 class="page__heading">Monitor de Actividades de Dependencias</h3>
    </div>        
    <br>
    ...
    <div class="row">
      <div class="col" align="left">
        <div class="pagination justify-content-start">
          <a class="btn btn-success" href="{{route('dependencia.index')}}">Atras</a>
        </div>
      </div>      
    </div> 
  </section>                                      
...
@section("scripts")
  ...
  btnroute = "{{ route('dependencialistmonitor') }}";
  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      'language'    : {
        ...
        deferRender: true,
        ajax:{
           url : '{{ route('dependencialistmonitor') }}',
           headers: {'X-CSRF-TOKEN': tokent},
           type: "POST",
           dataType: 'json'
         },
        columns: [
            {data: 'nom_dep', className: 'col-sm-2 text-left', name: 'nom_dep'},            
            {data: 'jefedependencia.nom_jefe', className: 'col-sm-2 text-left', name: 'nom_jefe'},            
            {data: 'region.nom_reg', className: 'col-sm-2 text-left', name: 'nom_reg'},            
