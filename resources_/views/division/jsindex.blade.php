...
var table;        
  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      "columns": [
                    { className: "col-lg-3 col-xs-6 col-sm-6 col-md-6 text-left" },
                    { className: "col-lg-2 col-xs-2 col-sm-2 col-md-2 text-left" },
                    { className: "col-lg-4 col-xs-4 col-sm-4 col-md-4 text-left" },
                    { className: "col-lg-4 col-xs-1 col-sm-1 col-md-1 text-left" },
      ...
      'language'    : {
        ...
        columns: [
            {data: 'descripcion', className: 'col-lg-3 col-xs-6 col-sm-6 col-md-6 text-left', name: 'descripcion'},
            ...
            {data: 'actual', className: 'col-lg-4 col-xs-1 col-sm-1 col-md-1 text-left', name: 'actual'},            
            {
              data: null,
              bSortable: false,
              mRender: function(data, type, value) {
                ...
                if (info.length!=-1) {                
                  if (value["editar"]>0) {
                    var xroute = "{{ route('division.edit',['division'=>'__iddivision']) }}";
                    xroute = xroute.replace('__iddivision', value["editar"]);
            ...
            },
            {
              ...
              mRender: function(data, type, value) {
                ...
                if (info.length!=-1) {                                
                  if (value["borrar"]>0) {
                    var xroute = "{{ route('division.destroy',['division'=>'__iddivision']) }}";
                    xroute = xroute.replace('__iddivision', value["borrar"]);
                    ...
                    doc['header'] = (function (page, pages) {
                        return {
                            table: {
                                ...
                                body: [
                                    [{ image: logo, width: 50 }],
                                    [{ text: 'Lista de divisiones', alignment: 'center', fontSize: 14, bold: true, margin: [0, 10, 0, 0] }],
                                    [
                                        {
                                            text:
                                                [
                ...
                customize: function ( win ) {                  
                    ...
                    $(win.document.body)
                        ...
                        .prepend(                          
                            ...
                            '<br><br><div style="font-size:18px;">Dependencia: '+general_dep+'<br>Ubicación: '+general_ubi+'<br>Región: '+general_reg+'</div><div align="center" style="font-size:20px;">Lista de divisiones</div>'
                        );
