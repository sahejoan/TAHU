...
{!!Form::close()!!}
  ...
  <section class="section">
    <div class="section-header">
      <h3 class="page__heading">Monitor de Actividades de Funcionarios</h3>
    </div>        
    <br>
...
@section("scripts")
  ...
  @include('funcionarios.jsshow')

  <script>
  var table;        
  $(document).ready(function(){ 
  btnroute = "{{ route('funcionarioslistmonitor') }}";
  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      'language'    : {
        ...
        deferRender: true,
        ajax:{
           url : '{{ route('funcionarioslistmonitor') }}',
