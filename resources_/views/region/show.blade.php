...
{!!Form::close()!!}
  ...
  <section class="section">
    <div class="section-header">
      <h3 class="page__heading">Monitor de Actividades de Región</h3>
    </div>        
    <br>
    ...
    <div class="row">
      <div class="col" align="left">
        <div class="pagination justify-content-start">
          <a class="btn btn-success" href="{{route('region.index')}}">Atras</a>
        </div>
      </div>      
    </div> 
  </section>                                      
...
@section("scripts")
  ...
  @include('region.jsshow')

  <script>
  var table;        
  $(document).ready(function(){ 
  btnroute = "{{ route('regionlistmonitor') }}";
  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      'language'    : {
        ...
        deferRender: true,
        ajax:{
           url : '{{ route('regionlistmonitor') }}',
           headers: {'X-CSRF-TOKEN': tokent},
           type: "POST",
           dataType: 'json'
         },
        columns: [
            {data: 'nom_reg', className: 'col-sm-2 text-left', name: 'nom_reg'},            
            {
              data: null,
              bSortable: true,
