...
{!!Form::model($objlfunciones, array('name' => 'form', 'route' => array('lfunciones.update',$objlfunciones->id), 'method' => 'put', 'ENCTYPE'=>'multipart/form-data', 'files' => true))!!}
...
<div class="wrapper">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="card card-primary" style="background-color: #ebdef0;">
                    <div class="card-header bg-purple">
                        <h3 class="card-title">Actualizar función</h3>
                    </div>
                    <form>
                        <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-xs-5 col-sm-5 col-md-5" align="center" >  
            ...
            <a href="{!!URL::route('lfunciones.index')!!}" class="btn btn-danger btn-flat" title="Cerrar Formulario"><i class="fa fa-ban"></i> Cancelar</a>
        </div>
        <div class="col-xs-1 col-sm-1 col-md-1">  
            &nbsp;
        </div>        
        <div class="col-xs-3 col-sm-3 col-md-3" align="center">  
            @if (Auth::user()->hasAnyPermission('7_Crear_funciones'))
            <a class="btn btn-success" href="{{route('lfunciones.create')}}">Nueva función</a>
            @endif
        </div>
    </div>
</div>
