...
{!!Form::close()!!}
  <section class="section">
    <div class="section-header">
      <h3 class="page__heading">Monitor de Actividades Funciones</h3>
    </div>        
    <br>
    ...
    <div class="row">
      <div class="col" align="left">
        <div class="pagination justify-content-start">
          <a class="btn btn-success" href="{{route('lfunciones.index')}}">Atras</a>
        </div>
      </div>      
    </div> 
  </section>                                      
...
@section("scripts")
  ...
  @include('lfunciones.jsshow')

  <script>
  var table;        
  $(document).ready(function(){ 
  btnroute = "{{ route('lfuncioneslistmonitor') }}";
  ...
  table = $('.yajra-datatable').DataTable({        
      ...
      'language'    : {
        ...
        deferRender: true,
        ajax:{
           url : '{{ route('lfuncioneslistmonitor') }}',
           headers: {'X-CSRF-TOKEN': tokent},
           type: "POST",
           dataType: 'json'
         },
        columns: [
            {data: 'descripcion', className: 'col-sm-2 text-left', name: 'descripcion'},            
            {
              data: null,
              bSortable: true,
