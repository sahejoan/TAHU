...
<div>
{!!Form::open(array('name' => 'form', 'route' => array('lfunciones.store'), 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data'))!!}     
                    ...
                    <form>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="label">Descripción de la función</label>
