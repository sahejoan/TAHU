...
class MonitorLcargosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('lcargos.show', array('objfechacarbon'=>$objfechacarbon));
    }

    public function getMonitorLcargos(Request $request)
    {
        if ($request->ajax()) {
        try {
          ...
          $obj = lcargos::with(['creator', 'editor', 'destroyer']);

          //Cuenta registros
          $totalregistros = lcargos::with(['creator', 'editor', 'destroyer'])
          ->orWhere('lcargo.descripcion','like','%'.$search.'%')
          ->count('lcargo.id');
          ...
          if(empty($request->input('search.value'))) {
            ...
            //filtering
            $totalFiltered = lcargos::with(['creator', 'editor', 'destroyer'])
            ->orWhere('lcargo.descripcion','like','%'.$search.'%')
