...
class CargoFuncionarioController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('role_or_permission:9_Crear_designacion|9_Editar_designacion|9_Borrar_designacion', ['only' => ['CrearCargoFuncionario','store','update','BorrarCargoFuncionario','VerCargoFuncionario']]);        
    }  
