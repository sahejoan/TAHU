    ...
    public function BuscarAsistencia(Request $request) 
    {
        try {
            ...
            if ($desde == "" && $hasta == "" ) {              
                ...
                return view('qrcodes.show', array('objasistencia'=>$objasistencia, 'busqueda'=>$busqueda, 'objfechacarbon'=>$objfechacarbon, 'desde'=>'', 'hasta'=>'', 'objdependencia'=>$objdependencia, 'objdivision'=>$objdivision, 'id_temp'=>$id_temp, 'id_tempdiv'=>$id_tempdiv, 'horaactual'=>$horaactual, 'objfuncionarios'=>$objfuncionarios));                
                ...
                if ($validation->fails()) {
                  ...
                  if ($rangodefecha['dias']<=$rangodia) {
                    ...
                    return view('qrcodes.show', array('objasistencia'=>$objasistencia, 'busqueda'=>$busqueda, 'objfechacarbon'=>$objfechacarbon, 'desde'=>$desde, 'hasta'=>$hasta, 'objdependencia'=>$objdependencia, 'objdivision'=>$objdivision, 'id_temp'=>$id_temp, 'id_tempdiv'=>$id_tempdiv, 'horaactual'=>$horaactual, 'objfuncionarios'=>$objfuncionarios));
