...
{	
  ...
  {    
    try {
      ...
      $objfuncionarios = funcionarios::select('funcionarios.cedula','funcionarios.nombre','funcionarios.apellido')
  ...
  public function tarjetapdf($id)
  {
    try { 
      ...
      $objfuncionarios = funcionarios::select('funcionarios.cedula','funcionarios.nombre','funcionarios.apellido')->where('id', '=', $id)
      ->orderBy('apellido','asc')
      ->orderBy('nombre','asc')
      ->get()->toArray();
