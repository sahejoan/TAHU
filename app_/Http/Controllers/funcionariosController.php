...
{ 
      ...
      public function index()
      {
        try {
          ...
          return view('funcionarios.index', array('busqueda'=>'', 'objdependencia'=>$objdependencia, 'id_temp'=>''));
    ...
    public function getFuncionarios(Request $request)
    {
        ...
        try {
          ...
          //Cuenta registros
            if ($estatus=='') {
              $totalregistros = funcionarios::select('funcionarios.id','funcionarios.cedula','funcionarios.apellido','funcionarios.nombre','funcionarios.fecha_nac','funcionarios.telefono_p','funcionarios.fecha_in',DB::raw('(if ((select designacion.estatus from designacion where designacion.id_func = funcionarios.id and designacion.estatus = "Activo")="Activo","Activo","")) as estatus'))
